...
<div class="z-0 flex h-24 w-24 animate-pulse justify-center bg-transparent">
	<div class="mt-4">
		<p
			class="body-sm mb-4 text-center font-light transition duration-300 ease-out"
			class:text-transparent={Y > 40}
		>
			scroll
		</p>
		<svg
			...
			y="0px"
			viewBox="0 0 172 172"
			class="mx-auto h-auto w-6 animate-bounce fill-current text-primary transition duration-300 ease-out"
