<div class="w-24 h-24 bg-transparent animate-pulse flex justify-center">
	<div class="mt-4">
		<p class="body-sm font-light text-center mb-4">scroll</p>
		<svg
			xmlns="http://www.w3.org/2000/svg"
			x="0px"
			y="0px"
			viewBox="0 0 172 172"
			class="text-primary fill-current animate-bounce w-6 h-auto mx-auto"
			><g
				fill="none"
				fill-rule="nonzero"
				stroke="none"
				...
				><path d="M0,172v-172h172v172z" fill="none" /><g class="text-primary fill-current"
					><path
