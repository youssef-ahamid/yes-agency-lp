  ...
  let onboarding = {
    ...
    success: {
      ...
      props: {
        title: "Request Sent!",
        subtitle:
          "We know you have a busy schedule, and w'll be in contact asap!",
        actions: [
          {
            underlined: true,
            to: "/",
...
<SEO
  ...
  description="Make your company extraordinary using the latest world-class marketing, technology & design innovations. From mega companies to record-breaking startups, we've helped market leaders of all sizes, across the MENA region and Europe, wow their customers and conquer their markets. Get started today"
/>
