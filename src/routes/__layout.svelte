...
<div
	class="bg-disabled decoration-blue decoration-purple decoration-orange decoration-green decoration-primary decoration-secondary decoration-tertiary ring-orange ring-green ring-purple ring-blue ring-tertiary ring-secondary ring-primary peer-checked:text-orange peer-checked:text-green peer-checked:text-purple peer-checked:text-blue peer-checked:text-tertiary peer-checked:text-secondary peer-checked:text-primary checked:bg-orange checked:bg-blue checked:bg-purple checked:bg-green checked:bg-tertiary checked:bg-secondary hover:bg-orange hover:bg-blue hover:bg-purple hover:bg-green hover:bg-tertiary hover:bg-secondary hover:text-orange hover:text-blue hover:text-blue-dark bg-blue-dark hover:ring-blue-dark hover:border-blue-dark hover:text-purple hover:text-green hover:text-tertiary hover:text-secondary hover:text-disabled hover:shadow-primary/20 hover:shadow-orange/20 hover:shadow-blue/20 hover:shadow-tertiary/20 hover:shadow-secondary/20 hover:shadow-green/20 hover:shadow-purple/20 hover:ring-disabled hover:ring-orange hover:ring-blue hover:ring-secondary hover:ring-primary hover:ring-blue hover:ring-tertiary hover:ring-secondary hover:ring-green hover:ring-purple focus:border-orange focus:border-blue focus:border-tertiary focus:border-secondary focus:border-green focus:border-purple focus:ring-orange focus:ring-green focus:ring-purple focus:ring-blue focus:ring-tertiary focus:ring-secondary focus:ring-primary"
/>
<div
